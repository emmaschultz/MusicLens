...
public class FlashingMetronome : MetronomeUtility {
    ...
    void Play() {
        ...
        switch (subdiv) {
            case 0:
                myAnimator.Play("FlashMetronomeDownbeat");
                //Debug.Log("Playing blink downbeat.");
                break;
            case 1:
                myAnimator.Play("FlashMetronomeEighth");
                break;
            case 2:
                myAnimator.Play("FlashMetronomeTriplet");
                break;
            case 3:
                myAnimator.Play("FlashMetronomeSixteenth");
                break;
        }
